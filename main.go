...
func main() {
	...
	router.HandleFunc("/singleEmployee", controller.SingleEmployee).Methods("GET")
	...
	router.HandleFunc("/deleteEmployeebyid", controller.DeleteEmployeeByID).Methods("DELETE")
	http.Handle("/", router)
